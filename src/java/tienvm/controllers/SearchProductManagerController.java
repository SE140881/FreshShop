...
public class SearchProductManagerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String search = request.getParameter("txtSearchAP");
            ProductDAO dao = new ProductDAO();
            List<ProductDTO> list = dao.findByProductName(search);
            request.setAttribute("INFOAP", list);
        } catch (Exception e) {
            log("Error at SearchProductManagerController: " + e.toString());
        } finally {
